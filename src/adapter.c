    ...
    )
{
    ...
    do
    {
        ...
        if (GlobalData.NdisVersion < NDIS_RUNTIME_VERSION_630) {
            ...
            regAttributes.Header.Revision = NDIS_SIZEOF_MINIPORT_ADAPTER_REGISTRATION_ATTRIBUTES_REVISION_2;
            regAttributes.AttributeFlags = TAP_ADAPTER_ATTRIBUTES_FLAGS | NDIS_MINIPORT_ATTRIBUTES_NO_PAUSE_ON_SUSPEND;
        }
